from rag.builder_code import expand_section_modules, recherche_hybride, expand_context, COLLECTION, embed_model
import os
...
# --- Config ---
load_dotenv()
GEN_MODEL = "gemini-2.5-flash"   # adapte si besoin (voir note en bas)
